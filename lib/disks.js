            ...
            used: function (callback) {
                switch (os.platform().toLowerCase()) {
                    case'darwin':
                        ...
                        break;
                    case'win32':
                          getDetailNaN('wmic logicaldisk get caption, freespace, size|find "' + drive + '"', function(e, d) {
            ...
            available: function (callback) {
                switch (os.platform().toLowerCase()) {
                    case'darwin':
                        ...
                        break;
                    case'win32':
                      getDetailNaN('wmic logicaldisk get caption, freespace|find "' + drive + '"', function(e, d) {
                        if(d) {
                          d = d.substr(2);
